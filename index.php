    ...
    $faqList = [
        ...
        [
            ...
            "answers" => [
                ...
                <ol class='top_ol'><li>1. La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
                    <ol class='bottom_ol'><li>a. Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
                    <li>b. Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol>
                <li>2. La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol>",
    ...
    <header>
        ...
        <div class="top_header">
            ...
            <div class="top_header_left">
                ...
                <span class="d_f">Domande frequenti</span>
            ...
            <div class="top_header_right">
                ...
                <div class="app_menu">
                    ...
                    <img src="img/app-menu-icon-10.jpg" alt="">
        ...
        <div class="footer_container">
            ...
            <div class="left_footer">
                ...
                <ul>
                    ...
                    <li><a href="à">Google</a></li>
                    <li>.</li>
                    <li><a href="à">Tutto su Google</a></li>
                    <li>.</li>
                    <li><a href="à">Privacy</a></li>
                    <li>.</li>
                    <li><a href="à">Termini</a></li>
